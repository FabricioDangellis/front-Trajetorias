  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="nav">
        ...
        <NavLink to="/pacientes" className={({ isActive }) => isActive ? "link active" : "link"}>
          <MdOutlineEmojiPeople className="icone" />
          <span>Pacientes</span>
        </NavLink>
        <NavLink to="/atendimentos" className={({ isActive }) => isActive ? "link active" : "link"}>
          <RiMentalHealthLine className="icone" />
          <span>Atendimentos</span>
        </NavLink>
        <NavLink to="/calendario" className={({ isActive }) => isActive ? "link active" : "link"}>
